...
ifeq ($(config),debug_win32)
  ...
  OBJDIR = obj/Win32/Debug/wxpdfdoc
...
ifeq ($(config),debug_win64)
  ...
  TARGET = $(TARGETDIR)/wxpdfdocd.lib
  OBJDIR = obj/Win64/Debug/wxpdfdoc
  DEFINES += -D_WINDOWS -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DDEBUG -D_DEBUG -D_LIB -DWXMAKINGLIB_PDFDOC -D_UNICODE -D__WXDEBUG__ -D__WXMSW__
  INCLUDES += -I"$(wxRootDir)/lib/$(wxCompilerPrefix)$(wxArchSuffix)_lib/msw$(wxSuffix)" -I"$(wxRootDir)/include" -I../include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_win32)
  ...
  OBJDIR = obj/Win32/Release/wxpdfdoc
...
ifeq ($(config),release_win64)
  ...
  TARGETDIR = ../lib/gcc_x64_lib
  TARGET = $(TARGETDIR)/wxpdfdoc.lib
  OBJDIR = obj/Win64/Release/wxpdfdoc
  DEFINES += -D_WINDOWS -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DNDEBUG -D_LIB -DWXMAKINGLIB_PDFDOC -D_UNICODE -D__WXMSW__
  INCLUDES += -I"$(wxRootDir)/lib/$(wxCompilerPrefix)$(wxArchSuffix)_lib/msw$(wxSuffix)" -I"$(wxRootDir)/include" -I../include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_wxdll_win32)
  ...
  TARGETDIR = ../lib/gcc_lib
  TARGET = $(TARGETDIR)/wxpdfdocd.lib
  OBJDIR = obj/Win32/Debug_wxDLL/wxpdfdoc
  DEFINES += -D_WINDOWS -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -D_LIB -DWXMAKINGLIB_PDFDOC -D_UNICODE -D__WXDEBUG__ -DWXUSINGDLL -D__WXMSW__
...
ifeq ($(config),debug_wxdll_win64)
  ...
  TARGETDIR = ../lib/gcc_x64_lib
  TARGET = $(TARGETDIR)/wxpdfdocd.lib
  OBJDIR = obj/Win64/Debug_wxDLL/wxpdfdoc
  DEFINES += -D_WINDOWS -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -D_LIB -DWXMAKINGLIB_PDFDOC -D_UNICODE -D__WXDEBUG__ -DWXUSINGDLL -D__WXMSW__
  INCLUDES += -I"$(wxRootDir)/lib/$(wxCompilerPrefix)$(wxArchSuffix)_dll/msw$(wxSuffix)" -I"$(wxRootDir)/include" -I../include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_wxdll_win32)
  ...
  TARGETDIR = ../lib/gcc_lib
  TARGET = $(TARGETDIR)/wxpdfdoc.lib
  OBJDIR = obj/Win32/Release_wxDLL/wxpdfdoc
  DEFINES += -D_WINDOWS -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -D_LIB -DWXMAKINGLIB_PDFDOC -D_UNICODE -DWXUSINGDLL -D__WXMSW__
  INCLUDES += -I"$(wxRootDir)/lib/$(wxCompilerPrefix)$(wxArchSuffix)_dll/msw$(wxSuffix)" -I"$(wxRootDir)/include" -I../include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m32 -O2
...
ifeq ($(config),release_wxdll_win64)
  ...
  TARGETDIR = ../lib/gcc_x64_lib
  TARGET = $(TARGETDIR)/wxpdfdoc.lib
  OBJDIR = obj/Win64/Release_wxDLL/wxpdfdoc
  DEFINES += -D_WINDOWS -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -D_LIB -DWXMAKINGLIB_PDFDOC -D_UNICODE -DWXUSINGDLL -D__WXMSW__
  INCLUDES += -I"$(wxRootDir)/lib/$(wxCompilerPrefix)$(wxArchSuffix)_dll/msw$(wxSuffix)" -I"$(wxRootDir)/include" -I../include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),dll_debug_win32)
  ...
  OBJDIR = obj/Win32/DLL_Debug/wxpdfdoc
...
ifeq ($(config),dll_debug_win64)
  ...
  TARGET = $(TARGETDIR)/wxpdfdocd.dll
  OBJDIR = obj/Win64/DLL_Debug/wxpdfdoc
  DEFINES += -D_WINDOWS -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DDEBUG -D_DEBUG -D_USRDLL -DWXMAKINGDLL_PDFDOC -D_UNICODE -D__WXDEBUG__ -DWXUSINGDLL -D__WXMSW__
  INCLUDES += -I"$(wxRootDir)/lib/$(wxCompilerPrefix)$(wxArchSuffix)_dll/msw$(wxSuffix)" -I"$(wxRootDir)/include" -I../include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),dll_release_win32)
  ...
  OBJDIR = obj/Win32/DLL_Release/wxpdfdoc
...
ifeq ($(config),dll_release_win64)
  ...
  TARGETDIR = ../lib/gcc_x64_dll
  TARGET = $(TARGETDIR)/wxpdfdoc.dll
  OBJDIR = obj/Win64/DLL_Release/wxpdfdoc
  DEFINES += -D_WINDOWS -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DNDEBUG -D_USRDLL -DWXMAKINGDLL_PDFDOC -D_UNICODE -DWXUSINGDLL -D__WXMSW__
  INCLUDES += -I"$(wxRootDir)/lib/$(wxCompilerPrefix)$(wxArchSuffix)_dll/msw$(wxSuffix)" -I"$(wxRootDir)/include" -I../include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
